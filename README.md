...
> **ملاحظة**: الكود المصدري لتطبيق Vite موجود داخل المجلد الفرعي `cems-frontend/`. تمت إضافة سكربتات في جذر المستودع لتشغيل أوامر npm مباشرة بدون الحاجة للدخول إلى المجلد الفرعي.

```bash
# من جذر المستودع
npm run install-app   # تثبيت الاعتمادات داخل cems-frontend/
